...
from compression_utils import CompressedReplayBuffer
...
class Workspace:
    ...
    def setup(self):
        ...
        self.train_env = dmc.make(
            ...
            self.cfg.seed,
            black_floor=self.cfg.black or self.cfg.full_compress,
            grayscale=self.cfg.half_compress or self.cfg.full_compress,
        )
        ...
        if self.cfg.half_compress or self.cfg.full_compress:
            print("Using observation compression!")
            self.replay_storage = CompressedReplayBuffer(
                ...
                self.cfg.discount,
                data_specs,
                use_sparse=self.cfg.full_compress,
            )
    ...
    def eval(self):
        ...
        with self.logger.log_and_dump_ctx(self.global_frame, ty="eval") as log:
            ...
            if self.cfg.full_compress:
                log(
                    "obs_nonzero_count",
                    self.replay_storage._obs_comp.get_nonzero_count(),
                )
